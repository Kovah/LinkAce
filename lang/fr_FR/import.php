...
return [
    ...
    'import_help' => 'Vous pouvez importer les signets existants de votre navigateur ici. Habituellement, les signets sont exportés dans un fichier .html par votre navigateur. Sélectionnez le fichier ici et démarrez l\'importation.<br>Selon le nombre de signets, ce processus peut prendre un certain temps.',
