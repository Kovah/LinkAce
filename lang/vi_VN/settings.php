...
return [
    ...
    'link_display_mode' => 'Chế độ hiển thị',
    ...
    'guest_sharing' => 'Chia sẻ liên kết với khách',
    ...
    'guest_access' => 'Cho phép khách truy cập',
    'guest_access_help' => 'Nếu bật, khách có thể xem toàn bộ liên kết không riêng tư.',
    'custom_header_content' => 'Nội dung phần đầu tùy chỉnh',
    'custom_header_content_help' => 'Nội dung đã nhập sẽ được đặt trước thẻ &lt;/head&gt; trên mọi trang LinkAce. Hữu dụng để đặt script analytics, mã nhúng. Lưu ý; nội dung không được xử lý mã hóa và có thể sẽ gây lỗi cho website!',
