    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6">
            ...
            <select id="darkmode_setting" name="darkmode_setting"
                ...
                <option value="0"
                    @if(guestsettings('darkmode_setting') === 0) selected @endif>
                    @lang('settings.darkmode_disabled')
                </option>
                <option value="1"
                    @if(guestsettings('darkmode_setting') === 1) selected @endif>
                    @lang('settings.darkmode_permanent')
                </option>
                <option value="2"
                    @if(guestsettings('darkmode_setting') === 2) selected @endif>
